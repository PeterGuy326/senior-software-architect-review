...
## 七、AIGC / 大模型工程化（⚠️ 官方大纲未覆盖）

> **重要声明**：AIGC 与大模型**不在软考架构师官方大纲内**。此处作为架构师**必备行业背景**收录，用于论文/案例中的"技术前沿"引用。作答综合知识题**切勿默认为考点**。
...
- 案例题：极少直接考，但云原生/大数据案例可能出现"AI 中台"背景板
- 论文：**"系统设计"**方向可写"基于大模型的智能客服/知识助手架构"
